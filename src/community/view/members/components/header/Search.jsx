...
const t = scoped('nti-profiles.community.view.members.components.header.Search', {
	search: 'Search'
});
	...
	render () {
		...
		return (
			<div className={cx('search')}>
				...
				<Input.Text className={cx('search-input')} value={searchTerm} onChange={updateSearchTerm} placeholder={t('search')} />
			</div>
		);
	}
}