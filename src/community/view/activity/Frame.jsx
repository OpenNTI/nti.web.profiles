...
function CommunityActivityFrame (props) {
	return (
		<Responsive.Container>
			<Responsive.Item query={Queries.Desktop} component={Frame} size={Sizes.Desktop} {...props} />
			<Responsive.Item query={Queries.Tablet} component={Frame} size={Sizes.Tablet} {...props} />
			<Responsive.Item query={Queries.Mobile} component={Frame} size={Sizes.Mobile} {...props} />
		</Responsive.Container>
	);
...
function Frame ({children, loading, error, channels, community, size, ...props}) {
	...
	return (
		<Loading.Placeholder loading={loading || !channels} fallback={<Loading.Spinner large />}>
			{React.Children.map(children, (child) => {
				return React.cloneElement(child, {size, channels, community, ...props});
			})}
		</Loading.Placeholder>
	);
}
