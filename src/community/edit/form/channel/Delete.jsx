...
const t = scoped('nti-profiles.community.edit.forum.channel.Delete', {
	confirm: {
		title: 'Are you sure?',
		message:
			'Deleting a channel will also delete all of its posts. Do you want to continue?',
	},
});
...
class DeleteChannel extends React.Component {
	...
	render() {
		...
		return (
			<button
				type="button"
				className={cx('delete', { disabled: !canDelete })}
				onClick={canDelete ? this.doDelete : null}
			>
