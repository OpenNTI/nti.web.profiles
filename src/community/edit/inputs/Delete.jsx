...
const t = scoped('nti-profiles.community.edit.inputs.Delete', {
	...
	description:
		"This community will no longer be visible, accessible, or searchable by anyone. Don't do this for fun—you'll regret it.",
...
export default class CommunityDeleteInput extends React.Component {
	...
	render() {
		...
		return (
			<div
				className={cx('community-delete', className, {
					locked: !unlocked,
				})}
			>
