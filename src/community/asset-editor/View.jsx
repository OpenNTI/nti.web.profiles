...
CommunityAssetEditor.syncAssets = (community) => community.save({backgroundURL: null});
...
export default function CommunityAssetEditor ({community, assetName, afterSave, onCancel}) {
